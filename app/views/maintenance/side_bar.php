...
<nav class='w3-sidebar w3-collapse w3-white w3-animate-left' style='z-index:3;width:300px;' id='mySidebar'><br>
    ...
    <div class='w3-bar-block'>
        ...
        <button class='w3-button w3-large w3-block w3-teal' style=''><a href='$base_url/home/load_view/maintenance' onclick='w3_close()' class='w3-bar-item w3-button w3-padding w3-large'><i class='fa fa-th-large fa-fw w3-margin-right'></i>MAINTENANCE</a></button>
        <button class='w3-button w3-large w3-block' style=''><a href='$base_url/home/load_view/electrical' onclick='w3_close()' class='w3-bar-item w3-button w3-padding w3-large'><i class='fa fa-th-large fa-fw w3-margin-right'></i>ELECTRICAL</a></button>
